...
export const messages: Catalogs = {
  en: {
    ...
    allowReviewLabel: "Let the learner reopen a task",
    allowReviewHint:
      "They can look at what they answered, read-only. They cannot change it.",
    reviewHint: "Select a task to see what you answered.",
    showAnswer: "See your answer",
    hideAnswer: "Hide",
  ...
  de: {
    ...
    allowReviewLabel: "Aufgaben erneut öffnen lassen",
    allowReviewHint:
      "Die eigene Antwort ist einsehbar, aber nicht mehr änderbar.",
    reviewHint: "Wähle eine Aufgabe, um deine Antwort zu sehen.",
    showAnswer: "Antwort ansehen",
