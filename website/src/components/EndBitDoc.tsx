import { DoResult, EndBit } from "@bitflow/core";
        ...
        <Card>
          ...
          <CardFooter>
            <ButtonGroup space="standard">
              <ButtonSecondaryLink
                href={`https://github.com/openpatch/bitflow/tree/main/packages/end-${name}`}
              >
                View Repository
              </ButtonSecondaryLink>
              <ButtonSecondaryLink
                href={`https://github.com/openpatch/bitflow/tree/main/website/src/pages/docs/bits/end-${name}`}
              >
                View Example Source
              </ButtonSecondaryLink>
              <ButtonSecondaryLink
                href={`https://www.npmjs.com/package/@bitflow/end-${name}`}
              >
                View on NPM
              </ButtonSecondaryLink>
            </ButtonGroup>
...
import { evaluate, End } from "@bitflow/end-${name}";
  ...
  />
        ...
        <Card>
          ...
          <CardContent>
            ...
            <Code language="json">
              {JSON.stringify(
                zodToJsonSchema(endBit.EndSchema as any),
                null,
                2
              )}
            </Code>
