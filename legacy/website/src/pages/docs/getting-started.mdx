...
assessment. A Flow is defined by nodes and edges. A edge connects two nodes. A node can either be an interactive
...
You can also browse all available [examples here](/docs/examples).
