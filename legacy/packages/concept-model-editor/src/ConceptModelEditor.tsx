...
export type ConceptModelEditorProps = {
  height?: BoxProps["height"];
  onSave?: (flow: Omit<ConceptModelEditorProps, "onSave">) => void;
  saving?: boolean;
...
export type ConceptModelEditorRef = {
  save: () => void;
};

export const ConceptModelEditor = forwardRef<
  ConceptModelEditorRef,
...
>(
  (
    ...
    const [selectedNode, setSelectedNode] =
      useState<ConceptModelEditorProps["latentVariables"][0]>();
